...
"""
ingest_index.py — generate icons/aws.json from the shape-index ground truth.

Source: icons/source/shape-index.json.gz (vendored from jgraph/drawio-mcp, Apache-2.0) —
...
Run: python3.12 src/ingest_index.py   (stdlib only)
"""
...
INDEX = ROOT / "icons" / "source" / "shape-index.json.gz"
OUT = ROOT / "icons" / "aws.json"
...
def main() -> None:
    ...
    catalog = {
        "meta": {
            "family": "mxgraph.aws4",
            "source": "Generated from icons/source/shape-index.json.gz (jgraph/drawio-mcp, Apache-2.0) — styles verbatim.",
            "incomplete": False,
            "generator": "src/ingest_index.py",
        },
        "categoryColors": {
